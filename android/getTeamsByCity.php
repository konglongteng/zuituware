...
//get which city by kong
$index = $_REQUEST['index'];
$maxresult = $_REQUEST['maxresult'];
...
$teams = DB::LimitQuery('team', array(
	'condition' => $condition,
	'order' => "ORDER BY sort_order DESC, id DESC limit $index,$maxresult",   //add limit for pager by kong  ' to  "  will compile $
));
